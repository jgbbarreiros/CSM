...
#seqbin = K3[len_val_bin)] 
#seqbin = K5[(run,len(val_bin))]
#K3.iteritems()
#K5.values()[index]
    
# Make the zigzag order
#dc_ac_array[ind_zz,:] = dc_ac_array

# Invert the zigzag order for all blocks
#dc_ac_array = dc_ac_array[ind_zz,:]
